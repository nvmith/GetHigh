...
## 🎮 프로젝트 소개
**Get High**은 Unity 기반의 **느와르 분위기와 로그라이크 요소가 결합된 2D 탑다운 슈팅 게임**입니다.  
플레이어는 다양한 무기와 마약(버프 & 디버프)을 활용해 끊임없이 변화하는 방을 돌파하고,  
...
- **25% 단위 디버프 시스템**
  - 취함 수치가 일정 단계(25%, 50%, 75%, 100%)에 도달할 때마다  
    **랜덤 디버프**가 자동 적용  
  - 플레이어에게 강화와 리스크 사이에서 전략적인 조절 요구
...
- 플레이어는 스스로를 강화하면서 동시에 그 리스크를 조절해야 하며,  
  **매 플레이마다 다른 조합/결과를 유도**하는 리플레이성을 확보
